...
export default defineConfig({
  ...
  build: {
    ...
    rollupOptions: {
      external: ['react', 'react-dom', 'react/jsx-runtime', 'react-dom/client', 'styled-components'],
      output: { inlineDynamicImports: true }, // the lazily loaded map picker stays inside the single library file
    },
  },
});
